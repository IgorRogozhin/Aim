...
public class WebAimGroupManager implements Serializable
{
	...
	/**
	 * Returns ArrayList with WebCollectors
	 * by a WebGroup's name where WebUser in by "byDeadline" or
	 * "byRate"
	 * @param dbm
	 * @param group
		...
		LocalDate deadline = null;
			...
			try
			{
				...
				while (rs.next())
				{
					...
					finally{collector.getWebAim().setDeadline(deadline);}
	...
	/**
	 * Returns ArrayList with WebCollectors
	 * by a WebGroup's name where WebUser in by rate=(solved-failed) 
	 * @param dbm
	 * @param groupName
	 * @return ArrayList with type WebCollector or null
	 */

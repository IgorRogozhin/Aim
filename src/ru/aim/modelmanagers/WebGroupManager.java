...
/**
 * 
 * Manages a WebGroup object creation cycle
...
public class WebGroupManager implements Serializable
{
	...
	/**
	 * Returns WebGroup if such object with
	...
	/**
	 * Returns a WebGroup if a WebUser 
	 * has already joined 
	 * @param dbm
	 * @param userId
	 * @return WebGroup or null
	...
	/**
	 * Returns a WebGroup with a WebUser
	 * signed to it
	 * @param dbm
	 * @param userId
	 * @param name
	 ...
	 * returns <b>true</b> if Group's been deleted
	 * @param dbm
	 * @param userId
	 * @param groupId
	 * @return boolean
